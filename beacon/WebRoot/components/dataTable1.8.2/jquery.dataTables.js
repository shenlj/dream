...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnAjaxParameters( oSettings )
		{
			...
			aoData = aoData.concat(oSettings.postData);
			if(aoData == undefined){
				aoData = [];
			}
			
			var i;
			aoData.push( { "name": "page.secho",          "value": oSettings.iDraw } );
			aoData.push( { "name": "iColumns",       "value": iColumns } );
			aoData.push( { "name": "scolumns",       "value": _fnColumnOrdering(oSettings) } );
			aoData.push( { "name": "page.idisplayStart",  "value": oSettings._iDisplayStart } );
			aoData.push( { "name": "page.idisplayLength", "value": oSettings.oFeatures.bPaginate !== false ?
        ...
        _fnMap( oSettings, oInit, "multiselect" );//多选择
				...
				_fnMap( oSettings, oInit, "page.idisplayLength", "_iDisplayLength" );
				...
				if ( typeof oInit["page.idisplayStart"] != 'undefined' && 
				     typeof oSettings.iInitDisplayStart == 'undefined' )
				{
					/* Display start point, taking into account the save saving */
					oSettings.iInitDisplayStart = oInit["page.idisplayStart"];
					oSettings._iDisplayStart = oInit["page.idisplayStart"];
				}
