...
public final class StringUtil extends org.apache.commons.lang.StringUtils {
	 ...
	 * @return 分割后的字符串数组。
	 */
	public static String[] split(final String seperators, final String list, final boolean include) {

		final StringTokenizer tokens = new StringTokenizer(list, seperators, include);
	...
	public static boolean booleanValue(final String tfString) {
		...
		final String trimmed = tfString.trim().toLowerCase();
	 ...
	 * @return
	 */
	public static final String[] explodeString(final String str, final String delim) {
	 ...
	 */
	public static String filterNull(final Object src, final String defaultValue) {
	 ...
	 * @return
	 */
	public static String left(final Object src, final int length, final String defaultValue) {

		if (src != null) {
			final String temp = src.toString();
	 ...
	 * @return
	 */
	public static String right(final Object src, final int length, final String defaultValue) {
	 ...
	 */
	public static String[] split(final String src, final String flag) {
	 ...
	 * @return 去掉扩展名后的文件名。
	 */
	public static String getFilenameWithNoExt(final String filename) {
	 ...
	 * @return 文件名的扩展名。
	 */
	public static String getFilenameExt(final String filename) {
	 ...
	 * @return int 解析后的整数。
	 */
	public static int toInt(final Object src, final int defaultValue) {
