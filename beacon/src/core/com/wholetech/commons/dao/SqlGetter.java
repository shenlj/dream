...
public class SqlGetter {
	...
	public void setAliasNames(final List<String> aliasNames) {
	...
	public String getSql(final String key) {
		...
		String value = null;
		for (final String alias : this.aliasNames) {
	 ...
	 * @return
	 */
	public String getSql(final String key, final String[] arguments) {
